...
parser.add_argument('--datasource', default='omniglot', type=str,
                    help='omniglot')
...
parser.add_argument('--logdir', default='/home/kim/liyuekeng/MLQA/Omniglot/logdict', type=str,
...
def train(args, maml, optimiser):
    ...
    print('best_acc is {}, note_ci95 is {}'.format(best_acc, note_ci95))
