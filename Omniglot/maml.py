...
class MAML(nn.Module):
    def __init__(self, args):
        ...
        self.args = args
        self.learner = Conv_Standard(args=args, x_dim=1, hid_dim=args.num_filters, z_dim=args.num_filters,
                            final_layer_size=64)
    ...
    def forward_MLQA(self, x1s, y1s, x1q, y1q, x2s, y2s, x2q, y2q):
        ...
        query_logits, q_label, s_label, lam = self.learner.functional_forward_full_our_mix(x1s, y1s, x2s, y2s, x1q, y1q, x2q, y2q,
                                                                                            sel_layer, 
                                                                                            shuffle_dict,
                                                                                            shuffle_channel_id,
                                                                                            fast_weights,
